...
class MainNav:
    def __init__(self, master2):
        ...
        self.TestButton = Button(self.master2,text = "L", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold", padx=13)
        ...
        self.QuestionButton = Button(self.master2,text = "C", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold")
        ...
        self.ResultsButton = Button(self.master2,text = "R", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold")
...
class AdminConsole:
    def __init__(self, master3):
        ...
        #Logic Test Button and Labels 
        self.TestButton = Button(self.master3,text = "L", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold", padx=13)
        self.TestButton.place(x= 300, y=200)
        ...
        #Questionnaire Button and Labels 
        self.QuestionButton = Button(self.master3,text = "C", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold")
        self.QuestionButton.place(x= 300, y=300)
        ...
        #Results Button and Labels
        self.ResultsButton = Button(self.master3,text = "R", command = lambda: hasNumbers(self), bg="#16A79D", fg = TextCol, font = "Ariel 40 bold")
        self.ResultsButton.place(x= 300, y=400)
